...
CAM_SA_KEY_PATH  = SECRETS_DIR + '/cam_service_account_key.json.encrypted'
...
if __name__ == '__main__':
    ...
    cam_api_key = mycam.api_key_create(deployment)

    print('Building CAM deployment service account...')
    deployment_sa = {
        'username': cam_api_key['username'],
        'apiKey': cam_api_key['apiKey'],
        'deploymentId': deployment['deploymentId'],
        'tenantId': cam_api_key['tenantId']
    }
    ...
    deployment_sa = kms_encode(key_name, json.dumps(deployment_sa))

    print('Done encrypting secrets.')

    cam_deployment_sa_create_key(deployment_sa, CAM_SA_KEY_PATH)
    ...
    settings = {
        ...
        'cam_credentials_file':           CAM_SA_KEY_PATH
    }
